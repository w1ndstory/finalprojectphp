...
class ProductController extends Controller
{
    ...
    public function downloadProductMadeInItaly()
    {
        $products = Products::where('madein_id', '5')->get();
        $filename = "product_made_in.csv";
        $handle = fopen($filename, 'w');
        fputcsv($handle, ['Product ID', 'Title', 'Name', 'Description', 'Date Created', 'Country']);
